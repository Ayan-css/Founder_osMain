...
const _platforms = ['LinkedIn', 'Email', 'Instagram', 'WhatsApp', 'Cold Call', 'Door to Door', 'Other'];
const _statuses = ['To Contact', 'Not Replied', 'Replied', 'Meeting Booked', 'Converted', 'Not Interested'];
...
class _OutreachScreenState extends ConsumerState<OutreachScreen> {
                ...
                data: (items) {
                  ...
                  if (filtered.isEmpty) {
                    return EmptyStateWidget(
                      ...
                      onAction: () => _showAddEditSheet(context, null),
                    );
                  }
                  if (_isKanbanMode) {
                    return _KanbanBoard(
                      ...
                      onStatusUpdate: (item, newStatus) async {
                        ...
                        onEdit: () => _showAddEditSheet(context, item),
  ...
  // ── Add/Edit sheet ───────────────────────────────────────────────────────
  void _showAddEditSheet(BuildContext context, OutreachItem? editing) {
    ...
    String status = editing?.status ?? _statuses.first;
